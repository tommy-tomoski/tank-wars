//========================================================================
// TankEvents.cpp : defines game-specific events for TankWars
//
...
// Note: these are game specific events, which really should be in TankEvents.cpp.
// They aren't because of an annoying dependancy in Network.cpp, which creates events
// from a bitstream. Once we get "real" streaming code in we can move these back to TankEvents.cpp.
...
void RegisterTankScriptEvents(void)
{
