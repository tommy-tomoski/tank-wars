#pragma once
//========================================================================
// TankEvents.h : defines game-specific events for TankWars
//
...
// Nasty game dependent events here. We'll move this back into game specific TankEvents.h when real streaming code 
