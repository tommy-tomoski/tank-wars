...
////////////////////////////////////////////////////
//
// class TankMeshNode9				- Chapter X, page Y
//
////////////////////////////////////////////////////

class D3DTankMeshNode9 : public D3DShaderMeshNode9
{
public:
	D3DTankMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t);
	virtual HRESULT VOnRestore(Scene *pScene);
};
...
class D3DTankMeshNode11 : public D3DShaderMeshNode11
{
public:
	D3DTankMeshNode11(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, RenderPass renderPass,const Mat4x4 *t)
		: D3DShaderMeshNode11(actorId, renderComponent, "art\\Tank.sdkmesh", renderPass, t) { }
