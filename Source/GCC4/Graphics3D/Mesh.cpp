...
//
// TankMeshNode::TankMeshNode					- Chapter X, page Y 
//
D3DTankMeshNode9::D3DTankMeshNode9(const ActorId actorId, WeakBaseRenderComponentPtr renderComponent, std::string fxFileName, RenderPass renderPass, const Mat4x4 *t)
...
//
// TankMeshNode::VOnRestore						- Chapter X, page Y
//
HRESULT D3DTankMeshNode9::VOnRestore(Scene *pScene)
{
	HRESULT hr;
	...
	//Rotate the Tank 90 degrees from default so that the spout faces forward
	Mat4x4 rotateY90;
